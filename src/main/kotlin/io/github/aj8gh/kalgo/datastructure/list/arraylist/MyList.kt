package io.github.aj8gh.kalgo.datastructure.list.arraylist

open class MyList<E> : MutableList<E> {
  ...
  override fun subList(fromIndex: Int, toIndex: Int): MyList<E> = TODO()
